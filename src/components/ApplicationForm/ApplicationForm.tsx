...
export default function ApplicationForm() {
  ...
  return (
    <div className="w-full mx-auto flex flex-col items-center justify-center lg:h-[300px]">
      ...
      >
        <div className="w-[290px] h-[45px] rounded-md border-[3.5px] border-white">
          <input
            type="text"
        ...
        <div className="w-[110px] h-[45px] rounded-md border-[3.5px] border-white">
          <input
            type="text"
        ...
        <div className="w-[300px] h-[45px] rounded-md border-[3.5px] border-white">
          <input
            type="text"
        ...
        <div className="w-[240px] h-[45px] rounded-md border-[3.5px] border-white">
          <input
            type="text"
